...
const Login = ({
  ...
  const handleLogin = (e) => {
    ...
    if (
      username === mockDataAdmin.userName &&
      password === mockDataAdmin.password
    ) {
      localStorage.setItem("isAuthenticated", "Admin"); // Set authentication status
      navigate("/"); // Redirect to the dashboard
    } else if (
      username === mockDataCustomer.userName &&
      password === mockDataCustomer.password
    ) {
      localStorage.setItem("isAuthenticated", "Customer"); // Set authentication status
      navigate("/"); // Redirect to the dashboard
    } else {
